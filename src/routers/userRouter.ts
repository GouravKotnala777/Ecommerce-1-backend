...
import { aaGET, aaPOST, addToWishlist, findUser, login, logout, me, myWishlist, register, removeAddress, updateMe, forgetPassword, verifyEmail, allUsersActivities, myReferralGifts, applyMyCoupon } from "../controllers/userController";
...
userRouter.route("/referee").get(isUserAuthenticated, myReferralGifts)
                            .post(isUserAuthenticated, applyMyCoupon);
